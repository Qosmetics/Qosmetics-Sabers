...
public:
    ...
    [[nodiscard]] Sombrero::FastVector3 NextPosition() const;
    [[nodiscard]] Sombrero::FastVector3 PreviousPosition() const;
    [[nodiscard]] Sombrero::FastVector3 NextNormal() const;
    [[nodiscard]] Sombrero::FastVector3 PreviousNormal() const;

    [[nodiscard]] bool IsValid() const;
    [[nodiscard]] Sombrero::FastVector3 GetNext2Position() const;
    [[nodiscard]] Sombrero::FastVector3 GetNext2Normal() const;
